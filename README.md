This is a [Laravel](https://travel-manage.org/) project bootstrapped with `composer create-project travel-manage/travel-manage travel-manage-wasmer-example` (with some minor adaptations for Wasmer).
